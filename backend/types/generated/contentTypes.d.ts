...
export interface ApiMissionUserMissionUser extends Struct.CollectionTypeSchema {
  collectionName: 'mission_users';
  info: {
    description: 'Link between mission and user assignment';
    displayName: 'MissionUser';
    pluralName: 'mission-users';
    singularName: 'mission-user';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiMissionMission extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Mission (set of quizzes)';
    displayName: 'Mission';
    pluralName: 'missions';
...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Individual task/quest within a mission';
    displayName: 'Task';
    pluralName: 'tasks';
    singularName: 'task';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['quiz', 'survey', 'action', 'other']> &
      Schema.Attribute.Required &
